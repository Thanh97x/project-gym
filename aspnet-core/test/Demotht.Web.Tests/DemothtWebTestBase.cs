...
{
    public abstract class DemothtWebTestBase : AbpAspNetCoreIntegratedTestBase<Startup>
    {
        protected static readonly Lazy<string> ContentRootFolder;

        static DemothtWebTestBase()
        {
        ...
        protected override IWebHostBuilder CreateWebHostBuilder()
        {
            return base
                ...
                .UseSetting(WebHostDefaults.ApplicationKey, typeof(DemothtWebMvcModule).Assembly.FullName);
        }
        ...
        {
            using (var context = IocManager.Resolve<DemothtDbContext>())
            {
                action(context);
                context.SaveChanges();
            }
        ...
        protected async Task UsingDbContextAsync(Func<DemothtDbContext, Task> action)
        {
            using (var context = IocManager.Resolve<DemothtDbContext>())
            {
        ...
        protected async Task<T> UsingDbContextAsync<T>(Func<DemothtDbContext, Task<T>> func)
        {
            T result;
